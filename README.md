...
|---|---|---|---|---|---|
| 第 2,730–3,229 条 | 日中翻译校对 | OpenAI ChatGPT | `translation-proofreading-v2` | 正在校对 | 2026-08-05 |

- 总进度：**2,729/21,204**
- 实际校对：**2,645/21,204**
- 跳过：**84/21,204**
- 当前机器可读占用记录：[`002730-003229-openai-chatgpt.json`](proofreading/claims/active/002730-003229-openai-chatgpt.json)
...
5. **统一同步**：应用 manifest，更新 JSON、Markdown、TXT 和 TSV。
6. **检查统计**：更新进度、跳过范围和实质修改数量。
7. **合并**：创建非草稿 PR，确认无冲突后合并到 `main`。
8. **释放范围**：删除或归档活动占用文件。
