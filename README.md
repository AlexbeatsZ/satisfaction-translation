...
|---|---|---|---|---|---|
| 第 3,230–3,729 条 | 日中翻译校对 | OpenAI ChatGPT | `translation-proofreading-v2` | 已占用，尚未开始 | 2026-08-05 |

- 总进度：**3,229/21,204**
- 实际校对：**3,145/21,204**
- 跳过：**84/21,204**
- 当前机器可读占用记录：[`003230-003729-openai-chatgpt.json`](proofreading/claims/active/003230-003729-openai-chatgpt.json)
