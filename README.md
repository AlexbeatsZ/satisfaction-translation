...
|---|---|---|---|---|---|
| 第 5,730–6,229 条 | 日中翻译校对 | OpenAI ChatGPT | `translation-proofreading-5730-6229` | 已占用，尚未开始 | 2026-08-05 |

- 总进度：**5,729/21,204**
- 实际校对：**5,400/21,204**
- 跳过：**329/21,204**
- 当前机器可读占用记录：[`005730-006229-openai-chatgpt.json`](proofreading/claims/active/005730-006229-openai-chatgpt.json)
